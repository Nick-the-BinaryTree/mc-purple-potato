...
public class ItemBow extends Item
{
    ...
    {
        if (par3EntityPlayer.capabilities.isCreativeMode || par3EntityPlayer.inventory.hasItem(Item.arrow.itemID) || par3EntityPlayer.inventory.hasItem(mod_Footprints.PotatoArrow.itemID))
        {

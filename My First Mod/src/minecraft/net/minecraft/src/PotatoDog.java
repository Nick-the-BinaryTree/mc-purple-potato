...
public class PotatoDog extends EntityWolf {
    ...
    public PotatoDog(World par1World)
    {
        super(par1World);
    ...
    protected void entityInit()
    {
        super.entityInit();
        	...
        	this.dataWatcher.addObject(2, new Integer(this.getHealth()));
        	this.dataWatcher.addObject(3, new Byte((byte)0));
        	this.dataWatcher.addObject(4, new Byte((byte)BlockCloth.getBlockFromDye(1)));
     ...
     */
    public PotatoDog spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        PotatoDog var2 = new PotatoDog(this.worldObj);
        this.dropItem(mod_Footprints.MegaPotato.itemID, 1);
